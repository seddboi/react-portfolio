		...
		<div class="contact-div" id="centered-title">
			...
			<div class="callout" id="contact-section">
				...
				<div class="bottom-text">
					...
					<div class="row-links">
						<a href="https://github.com/seddboi" target="_blank">
							<img class="links" src={github} alt="Github Link" />
						</a>
						<a href="https://www.linkedin.com/in/gian-zamora/" target="_blank">
							<img class="links" id="linkedin" src={linkedin} alt="LinkedIn Link" />
						</a>
						<a
							href="https://docs.google.com/document/d/13GkBST-zhbndjGA2Q9p30eVImBoOIslvF4NYbpHhWOg/edit?usp=sharing"
							target="_blank"
						>
