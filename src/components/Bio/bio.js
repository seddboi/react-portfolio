            ...
            <div class='grid-x align-center' id='top-layer'>
                <div class='callout large' id='about-me'>
                    ...
                    <p><strong>I'm a Full Stack Developer focusing primarily on contemporary design in web-based applications. Recently earned a certificate 
                        in full stack web development from UC Riverside Extension, attaining skills like Javascript, Node.js, SQL and React.js. Known to be a pragmatic 
                        ...
                        while working a fast paced environment and meeting deadlines.</strong> </p>
                    </div>
            </div>
        </ScrollAnimation>
    )
