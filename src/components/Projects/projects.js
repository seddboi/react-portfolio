...
function Projects() {
	...
	const projectInfo = {
		...
		pwdntr: {
			...
			link: 'https://graceful-dango-eb28ce.netlify.app',
		},
		saveashot: {
			...
			built:
				"This was a group project where I was assigned to develop the entire front end of the application. Every division, container, button, background, color, and overall design was all done by me. For a majority of the front end, I utilized components provided by Foundation by Zurb. This project's main goal was to serve as an informational in locating vaccinations for COVID 19 in California and providing informationals for every state on the vaccine and websites to schedule vaccines appointments.  ",
